<?php
/**
 * Title: Five Column Footer with text, links, social icons.
 * Slug: groundwp/footer-five-column
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent arcu magna, dignissim sed quam ultrices, pretium pellentesque quam.</p>
<!-- /wp:paragraph -->
<!-- wp:spacer {"height":"20px"} -->
<div style="height:20px" aria-hidden="true" class="wp-block-spacer"></div>
<!-- /wp:spacer -->
<!-- wp:social-links {"openInNewTab":true,"size":"has-normal-icon-size","align":"left","layout":{"type":"flex"}} -->
<ul class="wp-block-social-links alignleft has-normal-icon-size">
...
<p class="has-text-align-center">© <?php echo esc_html( gmdate( 'Y' ) ); ?> <a target="_blank" rel="noreferrer noopener nofollow" href="https://groundwp.com/">GroundWP Theme</a> by DotCamp</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->