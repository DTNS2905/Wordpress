...
<head>
    ...
    <body <?php body_class(); if (in_array("inner_menu", hc_get_now($HC_PAGE_ARR, array("page_setting","settings"), array())) || hc_get_setting('menu-one-page') == "checked") echo ' data-spy="scroll" data-target="#hc-inner-menu" data-offset="200"';?> <?php hc_echo(hc_get_setting('site-background-color'),'style="background-color: ',';"') ?>>
        <?php
        hc_header_engine();
    } else { 
